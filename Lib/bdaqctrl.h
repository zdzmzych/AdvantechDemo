...
BDAQINL int8              BufferedDoCtrl_getStreaming(BufferedDoCtrl *obj)                                                                { return DAQFN_TV(DNLAPI_DIO, 118, int8)(obj);                }
BDAQINL ErrorCode         BufferedDoCtrl_setStreaming(BufferedDoCtrl *obj, int8 value)                                                    { return DAQFN_ET(DNLAPI_DIO, 119, int8)(obj, value);         }
BDAQINL ErrorCode         BufferedDoCtrl_ReadPort(BufferedDoCtrl *obj, int32 portStart, int32 portCount, uint8 data[])                    { return DAQFN_ETTT(DNLAPI_DIO, 120, int32, int32, uint8 *)(obj, portStart, portCount, data); }
...
public:
   ...
   ErrorCode     ReadPort(int32 portStart, int32 portCount, uint8 data[])                 { return BufferedDoCtrl_ReadPort(this, portStart, portCount, data);  }
   ...
   bool              getStreaming()                                                       { return !!BufferedDoCtrl_getStreaming(this);      }
   ErrorCode         setStreaming(bool value)                                             { return BufferedDoCtrl_setStreaming(this, value); }
